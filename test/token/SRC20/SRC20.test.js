...
} = require('./SRC20.behavior');

const SRC20Mock = artifacts.require('SRC20Mock');

contract('SRC20', function ([_, initialHolder, recipient, anotherAccount]) {
  const initialSupply = new BN(100);

  beforeEach(async function () {
    this.token = await SRC20Mock.new(initialHolder, initialSupply);
  });

  shouldBehaveLikeSRC20('SRC20', initialSupply, initialHolder, recipient, anotherAccount);
  ...
  describe('decrease allowance', function () {
    ...
    describe('when the spender is the zero address', function () {
      ...
      it('reverts', async function () {
        await shouldFail.reverting.withMessage(this.token.decreaseAllowance(
          spender, amount, { from: initialHolder }, 'SRC20: approve to the zero address')
        );
      });
    });
  });
  ...
  describe('increase allowance', function () {
    ...
    describe('when the spender is the zero address', function () {
      ...
      it('reverts', async function () {
        await shouldFail.reverting.withMessage(
          this.token.increaseAllowance(spender, amount, { from: initialHolder }), 'SRC20: approve to the zero address'
        );
      });
    });
  });
  ...
  describe('_mint', function () {
    ...
    it('rejects a null account', async function () {
      await shouldFail.reverting.withMessage(
        this.token.mint(ZERO_ADDRESS, amount), 'SRC20: mint to the zero address'
      );
    });
  ...
  describe('_burn', function () {
    it('rejects a null account', async function () {
      await shouldFail.reverting.withMessage(this.token.burn(ZERO_ADDRESS, new BN(1)),
        'SRC20: burn from the zero address');
    });
  ...
  describe('_transfer', function () {
    shouldBehaveLikeSRC20Transfer('SRC20', initialHolder, recipient, initialSupply, function (from, to, amount) {
    ...
    describe('when the sender is the zero address', function () {
      it('reverts', async function () {
        await shouldFail.reverting.withMessage(this.token.transferInternal(ZERO_ADDRESS, recipient, initialSupply),
          'SRC20: transfer from the zero address'
        );
      });
    });
  });
  ...
  describe('_approve', function () {
    shouldBehaveLikeSRC20Approve('SRC20', initialHolder, recipient, initialSupply, function (owner, spender, amount) {
    ...
    describe('when the owner is the zero address', function () {
      it('reverts', async function () {
        await shouldFail.reverting.withMessage(this.token.approveInternal(ZERO_ADDRESS, recipient, initialSupply),
          'SRC20: approve from the zero address'
        );
      });
    });
  });
