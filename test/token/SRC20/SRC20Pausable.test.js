...
const SRC20PausableMock = artifacts.require('SRC20PausableMock');
const { shouldBehaveLikePublicRole } = require('../../behaviors/access/roles/PublicRole.behavior');

contract('SRC20Pausable', function ([_, pauser, otherPauser, recipient, anotherAccount, ...otherAccounts]) {
  const initialSupply = new BN(100);

  beforeEach(async function () {
    this.token = await SRC20PausableMock.new(pauser, initialSupply, { from: pauser });
  });
