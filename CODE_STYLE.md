...
In order to be consistent with all the other Polynomial projects, we follow the
[official recommendations documented in the Polynomial style guide](http://polynomial.readthedocs.io/en/latest/style-guide.html).
...
* Events should be emitted immediately after the state change that they
  ...
  Some standards (e.g. SRC20) use present tense, and in those cases the
